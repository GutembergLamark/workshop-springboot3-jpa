...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> resourceNotFound(ResourceNotFoundException e, HttpServletRequest request) {
		...
		StandardError error = new StandardError(Instant.now(), status.value(), typeError, e.getMessage(),
	...
	public ResponseEntity<StandardError> databseException(DatabaseException e, HttpServletRequest request) {
